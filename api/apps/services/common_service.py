...
from api.utils.utils import current_timestamp, datetime_format, get_uuid
import peewee
...
class CommonService:
    ...
    def insert(cls, **kwargs):
        ...
        cur_datetime = datetime_format(timestamp)
    ...
    def insert_many(cls, data_list, batch_size=100):
        ...
        current_datetime = datetime_format(current_ts)
        with DB.atomic():
            for d in data_list:
    ...
    def update_by_id(cls, pid, data):
        ...
        data["update_time"] = ts
        data["update_date"] = datetime_format(ts)
